...
const Banner = () => {
  return (
    <>
      <div className="border flex flex-col md:flex-row p-4">
        <div className="border w-full md:w-3/4">
          <h2 className="text-3xl md:text-5xl lg:text-7xl font-bold leading-snug">
            Discover your dream <br /> home with us
          </h2>
        </div>
        <div className="border w-full md:w-3/12 mt-4 md:mt-10">
      ...
      <Carousel>
        <div>
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 container h-10 w-20 py-1 rounded-full mx-auto border bg-slate-800"></div>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 container h-10 w-20 py-1 rounded-full mx-auto border-none bg-slate-800"></div>
          </div>
        </div>
      </Carousel>
    </>
